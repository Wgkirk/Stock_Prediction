...
def convert_input_pca_regression(request_body, request_content_type):
    ...
    if option == 2:
        ...
        EMA_10 = json.loads(request_body)[techIndicator_1]
        techIndicator_2 = 'EMA_15'
        EMA_15 = json.loads(request_body)[techIndicator_2]

        # Calculate the distance
        distances = np.sqrt(
            (X[techIndicator_1] - EMA_10)**2 + 
        ...
        closest_row[techIndicator_1] = EMA_10
